...
void download_file(char *sourceurl,char *destinationurl)
{
	CURL *curl;
		FILE *fp;
		CURLcode res;
		char *url = "http://192.168.88.128//home/metin/Desktop/dnm1/xml/metin";//"http://localhost/aaa.txt";
		char outfilename[FILENAME_MAX] = "/home/metin/Desktop/dnm1/xml/yedek/metin";
		curl = curl_easy_init();
		if (curl) {
			fp = fopen(/*outfilename*/destinationurl,"wb");
			curl_easy_setopt(curl, CURLOPT_URL, /*url*/sourceurl);
